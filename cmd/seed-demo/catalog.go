...
var serviceCatalog = []productCatalogEntry{
	{name: "Conseil — atelier stratégique (à l'heure)", priceCentsLo: 9000, priceCentsHi: 18000, qtyLo: 2, qtyHi: 16},
	{name: "Conseil — accompagnement à la mise en œuvre (à l'heure)", priceCentsLo: 7000, priceCentsHi: 14000, qtyLo: 2, qtyHi: 24},
	{name: "Assistance technique sur site (à l'heure)", priceCentsLo: 6000, priceCentsHi: 11000, qtyLo: 1, qtyHi: 12},
	{name: "Maintenance logicielle — forfait mensuel", priceCentsLo: 25000, priceCentsHi: 90000, qtyLo: 1, qtyHi: 1},
	{name: "Intégration système — forfait", priceCentsLo: 150000, priceCentsHi: 800000, qtyLo: 1, qtyHi: 1},
	{name: "Session de formation du personnel (demi-journée)", priceCentsLo: 40000, priceCentsHi: 90000, qtyLo: 1, qtyHi: 2},
	{name: "Mise en place de reporting personnalisé", priceCentsLo: 60000, priceCentsHi: 200000, qtyLo: 1, qtyHi: 1},
	{name: "Contrat de support annuel", priceCentsLo: 300000, priceCentsHi: 1200000, qtyLo: 1, qtyHi: 1},
	{name: "Service d'installation", priceCentsLo: 20000, priceCentsHi: 60000, qtyLo: 1, qtyHi: 3},
	{name: "Coordination logistique (par expédition)", priceCentsLo: 8000, priceCentsHi: 25000, qtyLo: 1, qtyHi: 4},
}
...
var motorcycleModelLines = []string{"Roadster", "Custom", "Trail", "Scrambler", "Scooter"}
...
var componentTemplates = []componentTemplate{
	{"Bloc moteur", tierEngineCore},
	{"Culasse", tierEngineCore},
	{"Vilebrequin", tierEngineCore},
	{"Carter de boîte de vitesses", tierEngineCore},
	{"Châssis", tierEngineCore},

	{"Fourche avant", tierMajorAssembly},
	{"Amortisseur arrière", tierMajorAssembly},
	{"Bras oscillant", tierMajorAssembly},
	{"Radiateur", tierMajorAssembly},
	{"Carburateur", tierMajorAssembly},
	{"Démarreur", tierMajorAssembly},
	{"Stator/alternateur", tierMajorAssembly},
	{"Faisceau électrique", tierMajorAssembly},
	{"Réservoir de carburant", tierMajorAssembly},
	{"Jante de roue", tierMajorAssembly},

	{"Kit piston", tierMidComponent},
	{"Bielle", tierMidComponent},
	{"Arbre à cames", tierMidComponent},
	{"Chaîne de distribution", tierMidComponent},
	{"Injecteur de carburant", tierMidComponent},
	{"Pompe à carburant", tierMidComponent},
	{"Kit disques d'embrayage", tierMidComponent},
	{"Chaîne de transmission", tierMidComponent},
	{"Kit pignons de chaîne", tierMidComponent},
	{"Tube de collecteur d'échappement", tierMidComponent},
	{"Silencieux d'échappement", tierMidComponent},
	{"Ventilateur de refroidissement", tierMidComponent},
	{"Pompe à huile", tierMidComponent},
	{"Étrier de frein", tierMidComponent},
	{"Disque de frein", tierMidComponent},
	{"Maître-cylindre", tierMidComponent},
	{"Moyeu de roue", tierMidComponent},
	{"Kit roulements de roue", tierMidComponent},
	{"Batterie", tierMidComponent},
	{"Régulateur de tension", tierMidComponent},

	{"Contacteur d'allumage", tierElectricalSmall},
	{"Bobine d'allumage", tierElectricalSmall},
	{"Bloc optique avant", tierElectricalSmall},
	{"Feu arrière", tierElectricalSmall},
	{"Kit clignotants", tierElectricalSmall},
	{"Bloc compteur", tierElectricalSmall},
	{"Klaxon", tierElectricalSmall},
	{"Guidon", tierElectricalSmall},
	{"Kit poignées de guidon", tierElectricalSmall},
	{"Kit rétroviseurs", tierElectricalSmall},

	{"Bougie d'allumage", tierSmallHardware},
	{"Câble d'embrayage", tierSmallHardware},
	{"Câble de frein", tierSmallHardware},
	{"Levier de frein", tierSmallHardware},
	{"Kit plaquettes de frein", tierSmallHardware},
	{"Filtre à air", tierSmallHardware},
	{"Filtre à huile", tierSmallHardware},
	{"Pneu", tierSmallHardware},
	{"Chambre à air", tierSmallHardware},
	{"Kit rayons", tierSmallHardware},
}
