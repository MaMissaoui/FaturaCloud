...
- `DELETE /api/production-orders/{id}` — draft only — cancel a completed order instead; DELETE carries AND status='draft' (F48 shape, audit 2026-09-14 F74), as does DeleteInboundDelivery's
