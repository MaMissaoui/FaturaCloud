...
### Fixed
- The app version badge in the header showed "vv3.25.0" instead of
  "v3.25.0" — the server already returns the full tag name and the
  frontend was prepending a second "v".
