    ...
    <>
      ...
      {failed && (
        <Alert
          ...
          type="error"
          showIcon
          message={<Trans>Couldn't load the AP aging report</Trans>}
          action={
      ...
      <Row>
        <Col span={24}>
          <Table
            ...
            locale={{ emptyText: failed ? "—" : <Trans>No outstanding bills</Trans> }}
            summary={() =>
          ...
          >
            ...
            <Table.Column
              ...
              key="vendorName"
              sorter={textSorter((r: any) => r.vendorName)}
            />
            <Table.Column
